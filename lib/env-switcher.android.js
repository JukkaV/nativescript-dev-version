...
class EnvSwitcherAndroid extends env_switcher_common_1.EnvSwitcherCommon {
    constructor(androidResourcesMigrationService, logger, platformData, projectData, environmentName, platformName) {
        super(logger, platformData, projectData, environmentName, platformName);
